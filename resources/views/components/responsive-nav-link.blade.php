...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-primary text-left text-base font-medium text-secondary bg-indigo-50 focus:outline-none focus:text-secondary focus:bg-indigo-100 focus:border-secondary transition duration-150 ease-in-out'
